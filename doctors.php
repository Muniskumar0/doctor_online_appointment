...
function fetchMedicalSpecialties($conn) {
...
function renderDoctorsList($conn, $ms_arr) {
    $where = "";
...
$ms_arr = fetchMedicalSpecialties($conn);
?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <hr class="divider">
                    <?php endif; ?>
                    <?php renderDoctorsList($conn, $ms_arr); ?>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function(){
        ...
        $('.set_appointment').click(function(event){
