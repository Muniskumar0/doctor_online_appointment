...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto my-2 my-lg-0">
                    ...
                    <?php else: ?>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="javascript:void(0)" id="login_now">Patient Login</a></li>
                        <li class="nav-item ml-lg-auto"><a class="nav-link js-scroll-trigger" href="admin/login.php">Admin Login</a></li>
                    <?php endif; ?>
                </ul>
            </div>
        </div>
    ...
    <footer class="bg-light py-5">
        ...
        <br>
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2024 - <?php echo $_SESSION['setting_name'] ?></div>
        </div>
    </footer>
